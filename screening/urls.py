...
from .views import MovieAPIView, HallAPIView, ShowtimeAPIView, SeatAPIView
...
urlpatterns = [
    ...
    path("/halls/<int:pk>", HallAPIView.as_view(), name="halls-detail" ),
    ...
    path("/showtimes/<int:pk>", ShowtimeAPIView.as_view(), name="showtime-detail")
]
